export default function superMemo(prevEF: number, prevReps: number, prevInterval: number, score: number) {
    const quality = Math.min(score + 1, 5); // score 1 => 2, 2 => 3, 3 => 4, 4 => 5
